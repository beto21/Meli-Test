...
import com.example.melitest.error.NetworkException
import com.example.melitest.utils.ErrorUtils
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideApiMovieService(retrofit: Retrofit): ApiMeli =
        retrofit.create(ApiMeli::class.java)
